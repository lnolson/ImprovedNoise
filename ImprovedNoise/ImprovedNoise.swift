//
//  ImprovedNoise.swift
//  Created by Loren Olson on 6/29/16.
//
...
class ImprovedNoise {
    static let permutation = [151,160,137,91,90,15,
    ...
    static func fade( _ t: Double ) -> Double {
        return t * t * t * (t * (t * 6 - 15) + 10)
    }
    
    
    static func lerp( t: Double, a: Double, b: Double) -> Double {
        return a + t * (b - a);
    }
    
    
    static func grad( hash: Int, x: Double, y: Double, z:Double ) -> Double {
